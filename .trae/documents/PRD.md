...
| 主页 | 导演阐述 | 左侧 sticky 大引文 + 右侧三段创作笔记 |
| 主页 | 角色卡 | 朔的肖像（AI 生成）+ 6 行人物设定 + 一句自述 |
| 主页 | 概念图廊 | 9 帧非对称网格，全部由 AI 提示词渲染 |
| 主页 | 声音设计 | 4 层声音卡片，每层含名称、标签、描述、独立波形条 |
| 主页 | 下集预告 | 旋转金环 + Vol. 02 标题 + 文字预告 + 返回首帧 CTA |
