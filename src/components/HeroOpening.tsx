...
export const HeroOpening: React.FC<Props> = ({ onStart }) => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-ink-950">
      ...
      {/* 太阳一抹 */}
      <div
        className="absolute right-[20%] top-[34%] w-32 h-32 rounded-full"
        style={{
          background: 'radial-gradient(circle, rgba(201,161,74,0.65), rgba(162,43,31,0.2) 60%, transparent 70%)',
          filter: 'blur(2px)',
        }}
      />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        >
          ...
          <p className="mt-6 text-silk-300/80 max-w-2xl mx-auto leading-8 font-serif">
            「墨卷为屏，江湖为幕」。四段长镜头徐徐展开，文房雅物与江湖典籍，悉列卷上。
            客官可自卷首下卷，览尽一段旖旎古意。
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.span
            ...
            className="text-gold-500/80 text-sm tracking-[0.4em] font-seal"
          >
            ↓
          </motion.span>
        </motion.button>
      ...
      <div className="absolute top-24 right-12 hidden md:flex flex-col items-end gap-1 opacity-80">
        ...
        <div className="text-[11px] font-seal tracking-[0.4em] text-silk-300/50">
          HRNMLJ · MMXXVI
        </div>
      </div>
      ...
      {/* 颗粒 */}
      <div className="absolute inset-0 grain opacity-30 mix-blend-overlay pointer-events-none" />
      {/* 暗角 */}
