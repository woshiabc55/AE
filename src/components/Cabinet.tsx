        ...
        {filters.map((f) => (
          <button
            ...
            className={`px-4 py-1.5 text-sm font-brush tracking-widest border transition ${
              filter === f
                ? 'bg-cinnabar text-silk-50 border-cinnabar shadow-seal'
        ...
        {list.map((it, i) => {
          ...
          return (
            <motion.article
              ...
              className={`card-paper p-6 group relative transition-all ${
                active?.id === it.id ? 'glow-cinnabar' : ''
              }`}
            >
              {/* 印章角标 */}
              ...
              {/* 器物图形（CSS + 印章色块） */}
              <div
                className="aspect-[3/4] mt-10 mb-6 relative grid place-items-center"
                style={{
                  background: `radial-gradient(ellipse at center, ${it.swatch}22, transparent 65%)`,
                }}
              >
                <ItemGlyph item={it} />
              </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-silk-300/60 text-sm">
                  共卷藏 {collection.length} 件 · 可于右上「已入卷」展开查看
                </div>
              </div>
            </div>
          </motion.div>
      ...
      return (
        <div className="relative w-32 h-32">
          <div
            ...
            style={{
              background: `linear-gradient(135deg, ${item.swatch}, #2a1f12)`,
    ...
    case 'paper':
      return (
        <div className="relative w-32 h-32">
          <div
            className="absolute inset-0"
            style={{ background: `${item.swatch}22`, border: `1px solid ${item.swatch}66` }}
          />
      ...
      return (
        <div className="relative w-40 h-24">
          <div
            ...
            style={{ background: `linear-gradient(90deg, ${item.swatch}, #F2E9D8, ${item.swatch})` }}
          />
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-10 h-5 bg-[#3D2A18] rounded-l" />
      ...
      return (
        <div className="relative w-32 h-32">
          <div
            ...
            style={{ background: `linear-gradient(180deg, ${item.swatch}, #0E0B08)` }}
          />
      ...
      return (
        <div className="relative w-32 h-32">
          <div
            ...
            style={{ background: `radial-gradient(circle at 30% 30%, ${item.swatch}, #0E0B08)` }}
          />
      ...
      return (
        <div className="relative w-24 h-32">
          <div
            ...
            style={{ background: `linear-gradient(180deg, ${item.swatch}, #3D2A18)` }}
          />
