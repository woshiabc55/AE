      ...
      <div className="px-8 py-4 flex items-center justify-between bg-gradient-to-b from-ink-950/95 via-ink-950/70 to-transparent backdrop-blur-sm">
        ...
        >
          ...
          <div className="flex flex-col leading-tight">
            <span className="font-brush text-xl text-silk-100 group-hover:text-gold-500 transition">
              HRNMLJ
            </span>
            <span className="text-[10px] tracking-[0.4em] text-silk-300/60 font-seal">
              墨卷为屏 · 江湖为幕
            </span>
          </div>
        </button>
        ...
        <button
          ...
          className={`btn-seal text-sm ${isKeeper ? 'ring-2 ring-gold-500' : ''}`}
        >
          {isKeeper ? '已入卷' : '入 卷'}
        </button>
      </div>
