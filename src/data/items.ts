...
export const items: Item[] = [
  {
    ...
    seal: '墨',
    price: 8800,
    story: '取千年松烟，配麝香、冰片、珍珠粉，研之无声，入纸如漆。',
    swatch: '#1B1A18',
    weight: '中',
    origin: '徽州·胡氏',
  },
  ...
  },
  {
    ...
    seal: '笔',
    price: 5600,
    story: '取辽东黄鼠狼尾尖一寸，束以鹿角，蘸墨可书蝇头小楷万字。',
    swatch: '#7A5A22',
    weight: '轻',
    origin: '湖州·善琏',
  },
  {
    ...
    seal: '砚',
    price: 36800,
    story: '石出斧柯，色青如雨，呵之出水。研墨无声，贮水不耗。',
    swatch: '#1B2A3A',
    weight: '重',
    origin: '肇庆·斧柯山',
  },
